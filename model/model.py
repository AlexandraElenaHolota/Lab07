...
class Model:
    def __init__(self):
        self.situazione_meta = None

    def get_situazioni(self, mese):
        return MeteoDao.get_situazioni(mese)

    def get_situazione_meta_mese(self, mese):
        self.situazione_meta = MeteoDao.get_situazioni_meta_mese(mese)
        return self.situazione_meta

    def get_soluzione_migliore(self, mese):
        self.__sequenza_ottima = []
        self.__costo_ottimo = -1
        self.__ricorsione_sequenza([], 0, self.get_situazione_meta_mese(mese))
